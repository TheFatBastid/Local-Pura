 ...
 */
#ifndef RFAL_RFST25R3918_H
#define RFAL_RFST25R3918_H
...
#include "rfal_rfst25r3918_analogConfig.h"
#include "rfal_rfst25r3918_iso15693_2.h"
#include "st25r3918_aat.h"
#include <functional>
...
typedef struct {
  ...
  uint8_t                 status[ST25R3918_FIFO_STATUS_LEN];   /*!< FIFO Status Registers                                              */
} rfalFIFO;


/*! Struct that holds RFAL's configuration settings                                                      */
typedef struct {
  uint8_t                 obsvModeTx;  /*!< RFAL's config of the ST25R3918's observation mode while Tx */
  uint8_t                 obsvModeRx;  /*!< RFAL's config of the ST25R3918's observation mode while Rx */
 ...
 *    - needs to be above FIFO water level of ST25R3918 (200)
...
typedef union { /*  PRQA S 0750 # MISRA 19.2 - Both members are of the same type, just different names.  Thus no problem can occur. */
  uint8_t PTMem_A[ST25R3918_PTM_A_LEN];       /*!< PT_Memory area allocated for NFC-A configuration               */
  uint8_t PTMem_F[ST25R3918_PTM_F_LEN];       /*!< PT_Memory area allocated for NFC-F configuration               */
  uint8_t TSN[ST25R3918_PTM_TSN_LEN];         /*!< PT_Memory area allocated for TSN - Random numbers              */
} t_rfalPTMem;
...
typedef void (*ST25R3918IrqHandler)(void);
...
#define RFAL_FIFO_OUT_WL                (ST25R3918_FIFO_DEPTH - RFAL_FIFO_IN_WL)      /*!< Number of bytes sent/out of the FIFO when WL interrupt occurs while Tx          */
...
#define RFAL_ST25R3918_GPT_MAX_1FC      rfalConv8fcTo1fc(  0xFFFFU )                  /*!< Max GPT steps in 1fc (0xFFFF steps of 8/fc    => 0xFFFF * 590ns  = 38,7ms)      */
#define RFAL_ST25R3918_NRT_MAX_1FC      rfalConv4096fcTo1fc( 0xFFFFU )                /*!< Max NRT steps in 1fc (0xFFFF steps of 4096/fc => 0xFFFF * 302us  = 19.8s )      */
#define RFAL_ST25R3918_NRT_DISABLED     0U                                            /*!< NRT Disabled: All 0 No-response timer is not started, wait forever              */
#define RFAL_ST25R3918_MRT_MAX_1FC      rfalConv64fcTo1fc( 0x00FFU )                  /*!< Max MRT steps in 1fc (0x00FF steps of 64/fc   => 0x00FF * 4.72us = 1.2ms )      */
#define RFAL_ST25R3918_MRT_MIN_1FC      rfalConv64fcTo1fc( 0x0004U )                  /*!< Min MRT steps in 1fc ( 0<=mrt<=4 ; 4 (64/fc)  => 0x0004 * 4.72us = 18.88us )    */
#define RFAL_ST25R3918_GT_MAX_1FC       rfalConvMsTo1fc( 5000U )                      /*!< Max GT value allowed in 1/fc                                                    */
#define RFAL_ST25R3918_GT_MIN_1FC       rfalConvMsTo1fc(RFAL_ST25R3918_SW_TMR_MIN_1MS)/*!< Min GT value allowed in 1/fc                                                    */
#define RFAL_ST25R3918_SW_TMR_MIN_1MS   1U                                            /*!< Min value of a SW timer in ms                                                   */
...
#define RFAL_NORXE_TOUT                 50U                                           /*!< Timeout to be used on a potential missing RXE - Silicon ST25R3918 Errata #TBD   */
...
#define RFAL_ST25R3918_AAT_SETTLE_OFF   20U                                           /*!< Time in ms required for AAT pins and Osc to settle after en bit off             */
#define RFAL_ST25R3918_AAT_SETTLE_ON    5U                                            /*!< Time in ms required for AAT pins and Osc to settle after en bit on              */
 ...
 *   512  : 4bit length
 *    64  : Half a bit duration due to ST25R3918 Coherent receiver (1/fc)         */
#define RFAL_FWT_A_ADJUSTMENT           (512U + 64U)

/*! FWT ISO14443B adjustment:
 *    SOF (14etu) + 1Byte (10etu) + 1etu (IRQ comes 1etu after first byte) - 3etu (ST25R3918 sends TXE 3etu after) */
...
#define rfalST25R3918ObsModeDisable()            st25r3918WriteTestRegister(0x01U, (0x40U))                        /*!< Disable ST25R3918 Observation mode                                   */
#define rfalST25R3918ObsModeTx()                 st25r3918WriteTestRegister(0x01U, (0x40U|gRFAL.conf.obsvModeTx))  /*!< Enable Tx Observation mode                                           */
#define rfalST25R3918ObsModeRx()                 st25r3918WriteTestRegister(0x01U, (0x40U|gRFAL.conf.obsvModeRx))  /*!< Enable Rx Observation mode                                           */


#define rfalCheckDisableObsMode()                if(gRFAL.conf.obsvModeRx != 0U){ rfalST25R3918ObsModeDisable(); } /*!< Checks if the observation mode is enabled, and applies on ST25R3918  */
#define rfalCheckEnableObsModeTx()               if(gRFAL.conf.obsvModeTx != 0U){ rfalST25R3918ObsModeTx(); }      /*!< Checks if the observation mode is enabled, and applies on ST25R3918  */
#define rfalCheckEnableObsModeRx()               if(gRFAL.conf.obsvModeRx != 0U){ rfalST25R3918ObsModeRx(); }      /*!< Checks if the observation mode is enabled, and applies on ST25R3918  */
...
class RfalRfST25R3918Class : public RfalRfClass {
  public:
    ...
    */
    ...
    RfalRfST25R3918Class(SPIClass *spi, int cs_pin, int int_pin, uint32_t spi_speed = 5000000);
    RfalRfST25R3918Class(TwoWire *i2c, int int_pin);
    ...
    */
    ...
    /*
    ******************************************************************************
    * RFAL ST25R3918 FUNCTION PROTOTYPES
    ******************************************************************************
    */
    ...
    /*!
     *****************************************************************************
     *  \brief  Initialise ST25R3918 driver
     *
     *  This function initialises the ST25R3918 driver.
     *
     *  \return ERR_NONE         : Operation successful
     *  \return ERR_HW_MISMATCH  : Expected HW do not match or communication error
     *****************************************************************************
     */
    ReturnCode st25r3918Initialize(void);

    /*!
     *****************************************************************************
     *  \brief  Deinitialize ST25R3918 driver
     *
     *  Calling this function deinitializes the ST25R3918 driver.
     *
     *****************************************************************************
     */
    void st25r3918Deinitialize(void);
     ...
     *                  0xff : don't set txrate (ST25R3918_BR_DO_NOT_SET)
     *  \param rxrate : speed is 2^rxrate * 106 kb/s
     *                  0xff : don't set rxrate (ST25R3918_BR_DO_NOT_SET)
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918SetBitrate(uint8_t txrate, uint8_t rxrate);
     ...
     *
     *  \return ERR_IO : Error during communication with ST25R3918
     *  \return ERR_NONE : No error
     *
     *****************************************************************************
     */
    ReturnCode st25r3918AdjustRegulators(uint16_t *result_mV);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918MeasureAmplitude(uint8_t *result);
     ...
     *
     *  \param[in] mpsv : one of ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd
     *                           ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_rf
     *                           ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_a
     *                           ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_d
     *                           ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_am
     *
     *  \return the measured voltage in raw format.
     *
     *****************************************************************************
     */
    uint8_t st25r3918MeasurePowerSupply(uint8_t mpsv);
     ...
     *                           ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_a
     *                           ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_d
     *                    or     ST25R3918_REG_REGULATOR_CONTROL_mpsv_vdd_am
     *
     *  \return the measured voltage in mV
     *
     *****************************************************************************
     */
    uint16_t st25r3918MeasureVoltage(uint8_t mpsv);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918MeasurePhase(uint8_t *result);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918MeasureCapacitance(uint8_t *result);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918CalibrateCapacitiveSensor(uint8_t *result);
     ...
     */
    uint32_t st25r3918GetNoResponseTime(void);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918SetNoResponseTime(uint32_t nrt_64fcs);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918SetStartNoResponseTimer(uint32_t nrt_64fcs);
     ...
     *****************************************************************************
     */
    void st25r3918SetGPTime(uint16_t gpt_8fcs);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918SetStartGPTimer(uint16_t gpt_8fcs, uint8_t trigger_source);

    /*!
     *****************************************************************************
     *  \brief  Sets the number Tx Bits
     *
     *  Sets ST25R3918 internal registers with correct number of complete bytes and
     *  bits to be sent
     *
     ...
     *****************************************************************************
     */
    void st25r3918SetNumTxBits(uint16_t nBits);
     ...
     *****************************************************************************
     */
    uint16_t st25r3918GetNumFIFOBytes(void);
     ...
     *****************************************************************************
     */
    uint8_t st25r3918GetNumFIFOLastBits(void);
     ...
     *  n number of TRFW
     *
     *  \param[in] FieldONCmd  : Field ON command to be executed ST25R3918_CMD_INITIAL_RF_COLLISION
     *                           or ST25R3918_CMD_RESPONSE_RF_COLLISION_N
     *  \param[in] pdThreshold : Peer Detection Threshold  (ST25R3918_REG_FIELD_THRESHOLD_trg_xx)
     *                           0xff : don't set Threshold (ST25R3918_THRESHOLD_DO_NOT_SET)
     *  \param[in] caThreshold : Collision Avoidance Threshold (ST25R3918_REG_FIELD_THRESHOLD_rfe_xx)
     *                           0xff : don't set Threshold (ST25R3918_THRESHOLD_DO_NOT_SET)
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918PerformCollisionAvoidance(uint8_t FieldONCmd, uint8_t pdThreshold, uint8_t caThreshold, uint8_t nTRFW);
     ...
     *
     *  5 bit IC type code for ST25R3918: 00101
     ...
     */
    bool st25r3918CheckChipID(uint8_t *rev);

    /*!
     *****************************************************************************
     *  \brief  Retrieves all  internal registers from ST25R3918
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918GetRegsDump(t_st25r3918Regs *regDump);

    /*!
     *****************************************************************************
     *  \brief  Check if command is valid
     *
     *  Checks if the given command is a valid ST25R3918 command
     *
     ...
     *****************************************************************************
     */
    bool st25r3918IsCmdValid(uint8_t cmd);

    /*!
     *****************************************************************************
     *  \brief  Configure the stream mode of ST25R3918
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918StreamConfigure(const struct st25r3918StreamConfig *config);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ExecuteCommandAndGetResult(uint8_t cmd, uint8_t resReg, uint8_t tout, uint8_t *result);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918GetRSSI(uint16_t *amRssi, uint16_t *pmRssi);


    /*
    ******************************************************************************
    * RFAL ST25R3918 COM FUNCTION PROTOTYPES
    ******************************************************************************
    */
    ...
    /*!
     *****************************************************************************
     *  \brief  Returns the content of a register within the ST25R3918
     *
     *  This function is used to read out the content of ST25R3918 registers.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ReadRegister(uint8_t reg, uint8_t *val);

    /*!
     *****************************************************************************
     *  \brief  Reads from multiple ST25R3918 registers
     *
     ...
     *  inside the ST25R3918 gets incremented automatically.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ReadMultipleRegisters(uint8_t reg, uint8_t *values, uint8_t length);

    /*!
     *****************************************************************************
     *  \brief  Writes a given value to a register within the ST25R3918
     *
     *  This function is used to write \a val to address \a reg within the ST25R3918.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WriteRegister(uint8_t reg, uint8_t val);

    /*!
     *****************************************************************************
     *  \brief  Writes multiple values to ST25R3918 registers
     *
     *  This function is used to write multiple values to the ST25R3918 using the
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WriteMultipleRegisters(uint8_t reg, const uint8_t *values, uint8_t length);

    /*!
     *****************************************************************************
     *  \brief  Writes values to ST25R3918 FIFO
     *
     *  This function needs to be called in order to write to the ST25R3918 FIFO.
     *
     *  \param[in]  values: pointer to a buffer containing the values to be written
     *                      to the FIFO.
     *  \param[in]  length: Number of values to be written.
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WriteFifo(const uint8_t *values, uint16_t length);

    /*!
     *****************************************************************************
     *  \brief  Read values from ST25R3918 FIFO
     *
     *  This function needs to be called in order to read from ST25R3918 FIFO.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ReadFifo(uint8_t *buf, uint16_t length);

    /*!
     *****************************************************************************
     *  \brief  Writes values to ST25R3918 PTM
     *
     *  Accesses to the begging of ST25R3918 Passive Target Memory (PTM A Config)
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WritePTMem(const uint8_t *values, uint16_t length);

    /*!
     *****************************************************************************
     *  \brief  Reads the ST25R3918 PTM
     *
     *  Accesses to the begging of ST25R3918 Passive Target Memory (PTM A Config)
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ReadPTMem(uint8_t *values, uint16_t length);

    /*!
     *****************************************************************************
     *  \brief  Writes values to ST25R3918 PTM F config
     *
     *  Accesses ST25R3918 Passive Target Memory F config and writes the given values
     *
     *  \param[in]  values: pointer to a buffer containing the values to be written
     *                      to the Passive Target Memory
     *  \param[in]  length: Number of values to be written.
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WritePTMemF(const uint8_t *values, uint16_t length);

    /*!
     *****************************************************************************
     *  \brief  Writes values to ST25R3918 PTM TSN Data
     *
     *  Accesses ST25R3918 Passive Target Memory TSN data and writes the given values
     *
     *  \param[in]  values: pointer to a buffer containing the values to be written
     *                      to the Passive Target Memory.
     *  \param[in]  length: Number of values to be written.
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WritePTMemTSN(const uint8_t *values, uint16_t length);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ExecuteCommand(uint8_t cmd);

    /*!
     *****************************************************************************
     *  \brief  Read a test register within the ST25R3918
     *
     *  This function is used to read the content of test address \a reg within the ST25R3918
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ReadTestRegister(uint8_t reg, uint8_t *val);

    /*!
     *****************************************************************************
     *  \brief  Writes a given value to a test register within the ST25R3918
     *
     *  This function is used to write \a val to test address \a reg within the ST25R3918
     *
     *  \param[in]  reg: Address of the register to write
     *  \param[in]  val: Value to be written
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918WriteTestRegister(uint8_t reg, uint8_t val);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ClrRegisterBits(uint8_t reg, uint8_t clr_mask);
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918SetRegisterBits(uint8_t reg, uint8_t set_mask);

    /*!
     *****************************************************************************
     *  \brief  Changes the given bits on a ST25R3918 register
     *
     *  This function is used if only a particular bits should be changed within
     *  an ST25R3918 register.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ChangeRegisterBits(uint8_t reg, uint8_t valueMask, uint8_t value);

    /*!
     *****************************************************************************
     *  \brief  Modifies a value within a ST25R3918 register
     *
     *  This function is used if only a particular bits should be changed within
     *  an ST25R3918 register.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ModifyRegister(uint8_t reg, uint8_t clr_mask, uint8_t set_mask);

    /*!
     *****************************************************************************
     *  \brief  Changes the given bits on a ST25R3918 Test register
     *
     *  This function is used if only a particular bits should be changed within
     *  an ST25R3918 register.
     *
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918ChangeTestRegisterBits(uint8_t reg, uint8_t valueMask, uint8_t value);
     ...
     */
    bool st25r3918CheckReg(uint8_t reg, uint8_t mask, uint8_t val);

    /*!
     *****************************************************************************
     *  \brief  Check if register ID is valid
     *
     *  Checks if the given register ID a valid ST25R3918 register
     *
     ...
     *****************************************************************************
     */
    bool st25r3918IsRegValid(uint8_t reg);


    /*
    ******************************************************************************
    * RFAL ST25R3918 INTERRUPT FUNCTION PROTOTYPES
    ******************************************************************************
    */
    ...
    /*!
     *****************************************************************************
     *  \brief  Wait until an ST25R3918 interrupt occurs
     *
     *  This function is used to access the ST25R3918 interrupt flags. Use this
     ...
     *****************************************************************************
     */
    uint32_t st25r3918WaitForInterruptsTimed(uint32_t mask, uint16_t tmo);
     ...
     *****************************************************************************
     */
    uint32_t st25r3918GetInterrupt(uint32_t mask);
     ...
     *****************************************************************************
     */
    void st25r3918InitInterrupts(void);
     ...
     *****************************************************************************
     */
    void st25r3918ModifyInterrupts(uint32_t clr_mask, uint32_t set_mask);
     ...
     *****************************************************************************
     */
    void st25r3918CheckForReceivedInterrupts(void);

    /*!
     *****************************************************************************
     *  \brief  Enable a given ST25R3918 Interrupt source
     *
     *  This function enables all interrupts given by \a mask,
     *  ST25R3918_IRQ_MASK_ALL enables all interrupts.
     *
     *  \param[in] mask: mask indicating the interrupts to be enabled
     *
     *****************************************************************************
     */
    void st25r3918EnableInterrupts(uint32_t mask);

    /*!
     *****************************************************************************
     *  \brief  Disable one or more a given ST25R3918 Interrupt sources
     *
     ...
     *****************************************************************************
     */
    void st25r3918DisableInterrupts(uint32_t mask);

    /*!
     *****************************************************************************
     *  \brief  Clear all ST25R3918 irq flags
     *
     *****************************************************************************
     */
    void st25r3918ClearInterrupts(void);

    /*!
     *****************************************************************************
     *  \brief  Clears and then enables the given ST25R3918 Interrupt sources
     *
     *  \param[in] mask: mask indicating the interrupts to be cleared and enabled
     *****************************************************************************
     */
    void st25r3918ClearAndEnableInterrupts(uint32_t mask);

    /*!
     *****************************************************************************
     *  \brief  Sets IRQ callback for the ST25R3918 interrupt
     *
     *****************************************************************************
     */
    void st25r3918IRQCallbackSet(void (*cb)(void));
     ...
     *****************************************************************************
     */
    void st25r3918IRQCallbackRestore(void);


    /*
    ******************************************************************************
    * RFAL ST25R3918 TIMER FUNCTION PROTOTYPES
    ******************************************************************************
    */
    ...
    /*
    ******************************************************************************
    * RFAL ST25R3918 AAT FUNCTION PROTOTYPES
    ******************************************************************************
    */
     ...
     *                             ST25R3918 (AAT_A,B) will be adapted.
     *
     *  \return ERR_IO    : Error during communication.
     ...
     *****************************************************************************
     */
    ReturnCode st25r3918AatTune(const struct st25r3918AatTuneParams *tuningParams, struct st25r3918AatTuneResult *tuningStatus);
  ...
  protected:
    ...
    ReturnCode aatHillClimb(const struct st25r3918AatTuneParams *tuningParams, struct st25r3918AatTuneResult *tuningStatus);
    int32_t aatGreedyDescent(uint32_t *f_min, const struct st25r3918AatTuneParams *tuningParams, struct st25r3918AatTuneResult *tuningStatus, int32_t previousDir);
    int32_t aatSteepestDescent(uint32_t *f_min, const struct st25r3918AatTuneParams *tuningParams, struct st25r3918AatTuneResult *tuningStatus, int32_t previousDir, int32_t previousDir2);
    ReturnCode aatMeasure(uint8_t serCap, uint8_t parCap, uint8_t *amplitude, uint8_t *phase, uint16_t *measureCnt);
    uint32_t aatCalcF(const struct st25r3918AatTuneParams *tuningParams, uint8_t amplitude, uint8_t phase);
    ReturnCode aatStepDacVals(const struct st25r3918AatTuneParams *tuningParams, uint8_t *a, uint8_t *b, int32_t dir);
    ...
    uint32_t gST25R3918NRT_64fcs;
    volatile st25r3918Interrupt st25r3918interrupt; /*!< Instance of ST25R3918 interrupt */
    uint32_t timerStopwatchTick;
    bool i2c_enabled;
    volatile bool isr_pending;
    volatile bool bus_busy;
    ST25R3918IrqHandler irq_handler;
};
