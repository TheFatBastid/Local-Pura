...
/*******************************************************************************/
uint32_t RfalRfST25R3918Class::timerCalculateTimer(uint16_t time)
{
  return (millis() + time);
}
...
/*******************************************************************************/
bool RfalRfST25R3918Class::timerIsExpired(uint32_t timer)
{
  uint32_t uDiff;
  int32_t sDiff;
...
/*******************************************************************************/
void RfalRfST25R3918Class::timerDelay(uint16_t tOut)
{
  uint32_t t;
...
/*******************************************************************************/
void RfalRfST25R3918Class::timerStopwatchStart(void)
{
...
/*******************************************************************************/
uint32_t RfalRfST25R3918Class::timerStopwatchMeasure(void)
{
