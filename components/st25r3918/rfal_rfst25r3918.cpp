 ...
 *
 *  RFAL implementation for ST25R3918
 */
...
/*******************************************************************************/
RfalRfST25R3918Class::RfalRfST25R3918Class(SPIClass *spi, int cs_pin, int int_pin, uint32_t spi_speed) : dev_spi(spi), cs_pin(cs_pin), int_pin(int_pin), spi_speed(spi_speed)
{
  ...
  gST25R3918NRT_64fcs = 0;
  memset((void *)&st25r3918interrupt, 0, sizeof(st25r3918Interrupt));
...
RfalRfST25R3918Class::RfalRfST25R3918Class(TwoWire *i2c, int int_pin) : dev_i2c(i2c), int_pin(int_pin)
{
  memset(&gRFAL, 0, sizeof(rfal));
  memset(&gRfalAnalogConfigMgmt, 0, sizeof(rfalAnalogConfigMgmt));
  memset(&iso15693PhyConfig, 0, sizeof(iso15693PhyConfig_t));
...
ReturnCode RfalRfST25R3918Class::rfalInitialize(void)
{
  ReturnCode err;

  // Only configure SPI CS pin if not in I2C mode
  if (!i2c_enabled) {
  ...
  // Note: Using polling mode instead of hardware interrupts for better compatibility
  if (int_pin >= 0) {
    pinMode(int_pin, INPUT);
    // Don't attach hardware interrupt - use polling in st25r3918WaitForInterruptsTimed instead
    // This avoids issues with some GPIO pins and ISR context problems
  }

  rfalAnalogConfigInitialize();              /* Initialize RFAL's Analog Configs */

  EXIT_ON_ERR(err, st25r3918Initialize());

  st25r3918ClearInterrupts();

  /* Disable any previous observation mode */
  rfalST25R3918ObsModeDisable();
  ...
  st25r3918ChangeRegisterBits(ST25R3918_REG_OP_CONTROL, ST25R3918_REG_OP_CONTROL_en_fd_mask, ST25R3918_REG_OP_CONTROL_en_fd_auto_efd);
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalCalibrate(void)
{
  uint16_t resValue;
  ...
  /*******************************************************************************/
  /* Perform ST25R3918 regulators and antenna calibration                        */
  /*******************************************************************************/

  /* Automatic regulator adjustment only performed if not set manually on Analog Configs */
  if (st25r3918CheckReg(ST25R3918_REG_REGULATOR_CONTROL, ST25R3918_REG_REGULATOR_CONTROL_reg_s, 0x00)) {
    /* Adjust the regulators so that Antenna Calibrate has better Regulator values */
    st25r3918AdjustRegulators(&resValue);
  }
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalAdjustRegulators(uint16_t *result)
{
  return st25r3918AdjustRegulators(result);
}


/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetUpperLayerCallback(rfalUpperLayerCallback pFunc)
{
  st25r3918IRQCallbackSet(pFunc);
}


/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetPreTxRxCallback(rfalPreTxRxCallback pFunc)
{
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetPostTxRxCallback(rfalPostTxRxCallback pFunc)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalDeinitialize(void)
{
  /* Deinitialize chip */
  st25r3918Deinitialize();
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetObsvMode(uint8_t txMode, uint8_t rxMode)
{
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalGetObsvMode(uint8_t *txMode, uint8_t *rxMode)
{
  if (txMode != NULL) {
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalDisableObsvMode(void)
{
  gRFAL.conf.obsvModeTx = RFAL_OBSMODE_DISABLE;
  gRFAL.conf.obsvModeRx = RFAL_OBSMODE_DISABLE;
}
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalSetMode(rfalMode mode, rfalBitRate txBR, rfalBitRate rxBR)
{
  /* Check if RFAL is not initialized */
  if (gRFAL.state == RFAL_STATE_IDLE) {
    return ERR_WRONG_STATE;
  ...
  switch (mode) {
    ...
    case RFAL_MODE_POLL_NFCA:
      ...
      st25r3918ClrRegisterBits(ST25R3918_REG_OP_CONTROL, ST25R3918_REG_OP_CONTROL_wu);

      /* Enable ISO14443A mode */
      st25r3918WriteRegister(ST25R3918_REG_MODE, ST25R3918_REG_MODE_om_iso14443a);
    ...
    case RFAL_MODE_POLL_NFCA_T1T:
      ...
      /* Enable Topaz mode */
      st25r3918WriteRegister(ST25R3918_REG_MODE, ST25R3918_REG_MODE_om_topaz);
    ...
    case RFAL_MODE_POLL_NFCB:
      ...
      st25r3918WriteRegister(ST25R3918_REG_MODE, ST25R3918_REG_MODE_om_iso14443b);

      /* Set the EGT, SOF, EOF and EOF */
      st25r3918ChangeRegisterBits(ST25R3918_REG_ISO14443B_1,
                                  (ST25R3918_REG_ISO14443B_1_egt_mask | ST25R3918_REG_ISO14443B_1_sof_mask | ST25R3918_REG_ISO14443B_1_eof),
                                  ((0U << ST25R3918_REG_ISO14443B_1_egt_shift) | ST25R3918_REG_ISO14443B_1_sof_0_10etu | ST25R3918_REG_ISO14443B_1_sof_1_2etu | ST25R3918_REG_ISO14443B_1_eof_10etu));

      /* Set the minimum TR1, SOF, EOF and EOF12 */
      st25r3918ChangeRegisterBits(ST25R3918_REG_ISO14443B_2,
                                  (ST25R3918_REG_ISO14443B_2_tr1_mask | ST25R3918_REG_ISO14443B_2_no_sof | ST25R3918_REG_ISO14443B_2_no_eof),
                                  (ST25R3918_REG_ISO14443B_2_tr1_80fs80fs));
    ...
    case RFAL_MODE_POLL_B_PRIME:
      ...
      st25r3918ChangeRegisterBits(ST25R3918_REG_ISO14443B_2,
                                  (ST25R3918_REG_ISO14443B_2_tr1_mask | ST25R3918_REG_ISO14443B_2_no_sof | ST25R3918_REG_ISO14443B_2_no_eof),
                                  (ST25R3918_REG_ISO14443B_2_tr1_80fs80fs | ST25R3918_REG_ISO14443B_2_no_sof));
    ...
    case RFAL_MODE_POLL_B_CTS:
      ...
      st25r3918ChangeRegisterBits(ST25R3918_REG_ISO14443B_2,
                                  (ST25R3918_REG_ISO14443B_2_tr1_mask | ST25R3918_REG_ISO14443B_2_no_sof | ST25R3918_REG_ISO14443B_2_no_eof),
                                  (ST25R3918_REG_ISO14443B_2_tr1_80fs80fs | ST25R3918_REG_ISO14443B_2_no_sof | ST25R3918_REG_ISO14443B_2_no_eof));
    ...
    case RFAL_MODE_POLL_NFCF:
      ...
      /* Enable FeliCa mode */
      st25r3918WriteRegister(ST25R3918_REG_MODE, ST25R3918_REG_MODE_om_felica);
    ...
    case RFAL_MODE_POLL_ACTIVE_P2P:
      ...
      st25r3918WriteRegister(ST25R3918_REG_MODE, (ST25R3918_REG_MODE_targ_init | ST25R3918_REG_MODE_om_nfc | ST25R3918_REG_MODE_nfc_ar_eof));

      /* External Field Detector enabled as Automatics on rfalInitialize() */

      /* Set NRT to start at end of TX (own) field */
      st25r3918ChangeRegisterBits(ST25R3918_REG_TIMER_EMV_CONTROL, ST25R3918_REG_TIMER_EMV_CONTROL_nrt_nfc, ST25R3918_REG_TIMER_EMV_CONTROL_nrt_nfc_off);
      ...
      st25r3918SetStartGPTimer((uint16_t)rfalConv1fcTo8fc(RFAL_AP2P_FIELDOFF_TRFW), ST25R3918_REG_TIMER_EMV_CONTROL_gptc_etx_nfc);

      /* Set PPon2 timer with the max time between our field Off and other peer field On : Tadt + (n x Trfw)    */
      st25r3918WriteRegister(ST25R3918_REG_PPON2, (uint8_t)rfalConv1fcTo64fc(RFAL_AP2P_FIELDON_TADTTRFW));
    ...
    case RFAL_MODE_LISTEN_ACTIVE_P2P:
      ...
      st25r3918WriteRegister(ST25R3918_REG_MODE, (ST25R3918_REG_MODE_targ_targ | ST25R3918_REG_MODE_om_targ_nfcip | ST25R3918_REG_MODE_nfc_ar_eof));
    ...
    case RFAL_MODE_LISTEN_NFCA:
      ...
      st25r3918WriteRegister(ST25R3918_REG_MODE, (ST25R3918_REG_MODE_targ | ST25R3918_REG_MODE_om_targ_nfca | ST25R3918_REG_MODE_nfc_ar_off));
    ...
    case RFAL_MODE_LISTEN_NFCF:
      ...
      st25r3918WriteRegister(ST25R3918_REG_MODE, (ST25R3918_REG_MODE_targ | ST25R3918_REG_MODE_om_targ_nfcf | ST25R3918_REG_MODE_nfc_ar_off));
...
/*******************************************************************************/
rfalMode RfalRfST25R3918Class::rfalGetMode(void)
{
  return gRFAL.mode;
}
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalSetBitRate(rfalBitRate txBR, rfalBitRate rxBR)
{
  ReturnCode ret;
  ...
  if ((RFAL_MODE_POLL_NFCV != gRFAL.mode) && (RFAL_MODE_POLL_PICOPASS != gRFAL.mode)) {
    ...
    EXIT_ON_ERR(ret, st25r3918SetBitrate((uint8_t)gRFAL.txBR, (uint8_t)gRFAL.rxBR));
  }
  ...
  switch (gRFAL.mode) {
    ...
    case RFAL_MODE_POLL_PICOPASS:
...

      {
        ...
        struct st25r3918StreamConfig      streamConf;
        ...
        st25r3918StreamConfigure(&streamConf);
      }
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalGetBitRate(rfalBitRate *txBR, rfalBitRate *rxBR)
{
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetErrorHandling(rfalEHandling eHandling)
{
  switch (eHandling) {
    case RFAL_ERRORHANDLING_NFC:
    case RFAL_ERRORHANDLING_NONE:
      st25r3918ClrRegisterBits(ST25R3918_REG_EMD_SUP_CONF, ST25R3918_REG_EMD_SUP_CONF_emd_emv);
      break;

    case RFAL_ERRORHANDLING_EMVCO:
      /* MISRA 16.4: no empty default statement (in case RFAL_SW_EMD is defined) */
      st25r3918ModifyRegister(ST25R3918_REG_EMD_SUP_CONF,
                              (ST25R3918_REG_EMD_SUP_CONF_emd_emv | ST25R3918_REG_EMD_SUP_CONF_emd_crc_prot | ST25R3918_REG_EMD_SUP_CONF_emd_res_bits | ST25R3918_REG_EMD_SUP_CONF_emd_thld_mask),
                              (ST25R3918_REG_EMD_SUP_CONF_emd_emv_on | ST25R3918_REG_EMD_SUP_CONF_emd_crc_prot_off | ST25R3918_REG_EMD_SUP_CONF_emd_res_bits_off | RFAL_EMVCO_RX_MAXLEN));
      break;
    default:
...
/*******************************************************************************/
rfalEHandling RfalRfST25R3918Class::rfalGetErrorHandling(void)
{
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetFDTPoll(uint32_t FDTPoll)
{
  gRFAL.timings.FDTPoll = MIN(FDTPoll, RFAL_ST25R3918_GPT_MAX_1FC);
}


/*******************************************************************************/
uint32_t RfalRfST25R3918Class::rfalGetFDTPoll(void)
{
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalSetFDTListen(uint32_t FDTListen)
{
  gRFAL.timings.FDTListen = MIN(FDTListen, RFAL_ST25R3918_MRT_MAX_1FC);
}

/*******************************************************************************/
uint32_t RfalRfST25R3918Class::rfalGetFDTListen(void)
{
  return gRFAL.timings.FDTListen;
}

void RfalRfST25R3918Class::rfalSetGT(uint32_t GT)
{
  gRFAL.timings.GT = MIN(GT, RFAL_ST25R3918_GT_MAX_1FC);
}

/*******************************************************************************/
uint32_t RfalRfST25R3918Class::rfalGetGT(void)
{
  return gRFAL.timings.GT;
}

/*******************************************************************************/
bool RfalRfST25R3918Class::rfalIsGTExpired(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalFieldOnAndStartGT(void)
{
  ReturnCode ret;
  ...
  if (!st25r3918IsOscOn() || (gRFAL.state < RFAL_STATE_INIT)) {
    return ERR_WRONG_STATE;
  }
  ...
  if (!st25r3918IsTxEnabled() || !gRFAL.field) {
    /* Set TARFG: 0 (75us+0ms=75us), GT is fulfilled using a SW timer */
    st25r3918WriteRegister(ST25R3918_REG_FIELD_ON_GT, 0U);

    /* Use Thresholds set by AnalogConfig */
    ret = st25r3918PerformCollisionAvoidance(ST25R3918_CMD_INITIAL_RF_COLLISION, ST25R3918_THRESHOLD_DO_NOT_SET, ST25R3918_THRESHOLD_DO_NOT_SET, 0);

    gRFAL.field = st25r3918IsTxEnabled(); //(ret == ERR_NONE);

    /* Only turn on Receiver and Transmitter if field was successfully turned On */
    if (gRFAL.field) {
      st25r3918TxRxOn(); /* Enable Tx and Rx (Tx is already On)*/
    }
  }
  ...
  if ((gRFAL.timings.GT != RFAL_TIMING_NONE)) {
    ...
    rfalTimerStart(gRFAL.tmr.GT, rfalConv1fcToMs(MAX((gRFAL.timings.GT), RFAL_ST25R3918_GT_MIN_1FC)));
  }
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalFieldOff(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalStartTransceive(const rfalTransceiveContext *ctx)
{
  ...
  if ((gRFAL.state >= RFAL_STATE_MODE_SET) /*&& (gRFAL.TxRx.state == RFAL_TXRX_STATE_INIT )*/) {
    ...
    if (!st25r3918IsTxEnabled() && (!rfalIsModePassiveListen(gRFAL.mode) && (ctx->txBuf != NULL))) {
      return ERR_WRONG_STATE;
    }
    ...
    if (gRFAL.timings.FDTListen != RFAL_TIMING_NONE) {
      ...
      st25r3918ClrRegisterBits(ST25R3918_REG_TIMER_EMV_CONTROL, ST25R3918_REG_TIMER_EMV_CONTROL_mrt_step);

      /* If Correlator is being used further adjustment is required for NFCB */
      if ((st25r3918CheckReg(ST25R3918_REG_AUX, ST25R3918_REG_AUX_dis_corr, 0x00U)) && (gRFAL.mode == RFAL_MODE_POLL_NFCB)) {
        FxTAdj += (uint32_t)RFAL_FDT_LISTEN_B_ADJT_CORR;                                                                                        /* Reduce FDT(Listen)                   */
        st25r3918SetRegisterBits(ST25R3918_REG_CORR_CONF1, ST25R3918_REG_CORR_CONF1_corr_s3);                                                   /* Ensure BPSK start to 33 pilot pulses */
        st25r3918ChangeRegisterBits(ST25R3918_REG_SUBC_START_TIME, ST25R3918_REG_SUBC_START_TIME_sst_mask, RFAL_FDT_LISTEN_B_ADJT_CORR_SST);    /* Set sst                              */
      }

      /* Set Minimum FDT(Listen) in which PICC is not allowed to send a response */
      st25r3918WriteRegister(ST25R3918_REG_MASK_RX_TIMER, (uint8_t)rfalConv1fcTo64fc((FxTAdj > gRFAL.timings.FDTListen) ? RFAL_ST25R3918_MRT_MIN_1FC : (gRFAL.timings.FDTListen - FxTAdj)));
    }
    ...
    if ((gRFAL.TxRx.ctx.fwt != RFAL_FWT_NONE) && (gRFAL.TxRx.ctx.fwt != 0U)) {
      ...
      gRFAL.TxRx.ctx.fwt = MIN((gRFAL.TxRx.ctx.fwt + FxTAdj), RFAL_ST25R3918_NRT_MAX_1FC);

      /* Set FWT in the NRT */
      st25r3918SetNoResponseTime(rfalConv1fcTo64fc(gRFAL.TxRx.ctx.fwt));
    } else {
      /* Disable NRT, no NRE will be triggered, therefore wait endlessly for Rx */
      st25r3918SetNoResponseTime(RFAL_ST25R3918_NRT_DISABLED);
    }
    ...
    if ((gRFAL.TxRx.ctx.txBuf == NULL) || (gRFAL.TxRx.ctx.txBufLen == 0U)) {
      ...
      st25r3918ExecuteCommand(ST25R3918_CMD_UNMASK_RECEIVE_DATA);

      /* Start NRT manually, if FWT = 0 (wait endlessly for Rx) chip will ignore anyhow */
      st25r3918ExecuteCommand(ST25R3918_CMD_START_NO_RESPONSE_TIMER);
...
/*******************************************************************************/
bool RfalRfST25R3918Class::rfalIsTransceiveInTx(void)
{
...
/*******************************************************************************/
bool RfalRfST25R3918Class::rfalIsTransceiveInRx(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalTransceiveBlockingTx(uint8_t *txBuf, uint16_t txBufLen, uint8_t *rxBuf, uint16_t rxBufLen, uint16_t *actLen, uint32_t flags, uint32_t fwt)
{
  ReturnCode               ret;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalTransceiveRunBlockingTx(void)
{
  ReturnCode ret;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalTransceiveBlockingRx(void)
{
  ReturnCode ret;
  uint32_t startTime = millis();
  const uint32_t BLOCKING_RX_TIMEOUT_MS = 1000;  /* Safety timeout to prevent watchdog reset */
  ...
  do {
    ...
    if ((millis() - startTime) > BLOCKING_RX_TIMEOUT_MS) {
      ret = ERR_TIMEOUT;
      break;
    }
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalTransceiveBlockingTxRx(uint8_t *txBuf, uint16_t txBufLen, uint8_t *rxBuf, uint16_t rxBufLen, uint16_t *actLen, uint32_t flags, uint32_t fwt)
{
  ReturnCode ret;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalRunTransceiveWorker(void)
{
...
/*******************************************************************************/
rfalTransceiveState RfalRfST25R3918Class::rfalGetTransceiveState(void)
{
  return gRFAL.TxRx.state;
}

ReturnCode RfalRfST25R3918Class::rfalGetTransceiveStatus(void)
{
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalGetTransceiveRSSI(uint16_t *rssi)
{
  uint16_t amRSSI;
  uint16_t pmRSSI;
  bool     isSumMode;
  ...
  st25r3918GetRSSI(&amRSSI, &pmRSSI);

  /* Check if Correlator Summation mode is being used */
  isSumMode = (st25r3918CheckReg(ST25R3918_REG_CORR_CONF1, ST25R3918_REG_CORR_CONF1_corr_s4, ST25R3918_REG_CORR_CONF1_corr_s4) ? st25r3918CheckReg(ST25R3918_REG_AUX, ST25R3918_REG_AUX_dis_corr, 0x00) : false);
  if (isSumMode) {
    /*******************************************************************************/
    ...
    *rssi = (st25r3918CheckReg(ST25R3918_REG_AUX_DISPLAY, ST25R3918_REG_AUX_DISPLAY_a_cha, ST25R3918_REG_AUX_DISPLAY_a_cha) ? pmRSSI : amRSSI);
  }
  return ERR_NONE;
}
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalWorker(void)
{
  /* Poll for new interrupts if IRQ pin is valid and high (interrupt pending) */
  if ((int_pin >= 0) && (digitalRead(int_pin) == HIGH)) {
    st25r3918CheckForReceivedInterrupts();
  }

  /* Yield to prevent watchdog timeout during tight polling loops */
  yield();
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalErrorHandling(void)
{
  ...
  if (gRFAL.mode == RFAL_MODE_POLL_NFCA) {
    ...
    if ((gRFAL.TxRx.status == ERR_PAR) || (gRFAL.TxRx.status == ERR_CRC)) {
      if (rfalFIFOStatusIsIncompleteByte()) {
        st25r3918ReadFifo((uint8_t *)(gRFAL.TxRx.ctx.rxBuf), fifoBytesToRead);
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalCleanupTransceive(void)
{
  /*******************************************************************************/
  /* Transceive flags                                                            */
  /*******************************************************************************/
  ...
  st25r3918ClrRegisterBits(ST25R3918_REG_ISO14443A_NFC, (ST25R3918_REG_ISO14443A_NFC_no_tx_par | ST25R3918_REG_ISO14443A_NFC_no_rx_par | ST25R3918_REG_ISO14443A_NFC_nfc_f0));

  /* Restore AGC enabled */
  st25r3918SetRegisterBits(ST25R3918_REG_RX_CONF2, ST25R3918_REG_RX_CONF2_agc_en);
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalPrepareTransceive(void)
{
  ...
  if (!rfalIsModePassiveListen(gRFAL.mode)) {
    ...
    st25r3918ExecuteCommand(ST25R3918_CMD_STOP);

    /* Reset Rx Gain */
    st25r3918ExecuteCommand(ST25R3918_CMD_RESET_RXGAIN);
  } else {
    /* In Passive Listen Mode do not use STOP as it stops FDT timer */
    st25r3918ExecuteCommand(ST25R3918_CMD_CLEAR_FIFO);
  }
  ...
  if (rfalIsModePassiveComm(gRFAL.mode)) {   /* Passive Comms */
    ...
    if (gRFAL.timings.FDTPoll != RFAL_TIMING_NONE) {
      ...
      st25r3918SetStartGPTimer((uint16_t)rfalConv1fcTo8fc(MIN(gRFAL.timings.FDTPoll, (gRFAL.timings.FDTPoll - RFAL_FDT_POLL_ADJUSTMENT))), ST25R3918_REG_TIMER_EMV_CONTROL_gptc_erx);
    }
  }
  ...
  maskInterrupts = (ST25R3918_IRQ_MASK_FWL  | ST25R3918_IRQ_MASK_TXE  |
                    ST25R3918_IRQ_MASK_RXS  | ST25R3918_IRQ_MASK_RXE  |
                    ST25R3918_IRQ_MASK_PAR  | ST25R3918_IRQ_MASK_CRC  |
                    ST25R3918_IRQ_MASK_ERR1 | ST25R3918_IRQ_MASK_ERR2 |
                    ST25R3918_IRQ_MASK_NRE);

  /*******************************************************************************/
  /* Transceive flags                                                            */
  /*******************************************************************************/

  reg = (ST25R3918_REG_ISO14443A_NFC_no_tx_par_off | ST25R3918_REG_ISO14443A_NFC_no_rx_par_off | ST25R3918_REG_ISO14443A_NFC_nfc_f0_off);

  /* Check if NFCIP1 mode is to be enabled */
  if ((gRFAL.TxRx.ctx.flags & (uint8_t)RFAL_TXRX_FLAGS_NFCIP1_ON) != 0U) {
    reg |= ST25R3918_REG_ISO14443A_NFC_nfc_f0;
  }
  ...
  if ((gRFAL.TxRx.ctx.flags & (uint8_t)RFAL_TXRX_FLAGS_PAR_RX_KEEP) != 0U) {
    reg |= ST25R3918_REG_ISO14443A_NFC_no_rx_par;
  }

  /* Check if automatic Parity bits is to be disabled */
  if ((gRFAL.TxRx.ctx.flags & (uint8_t)RFAL_TXRX_FLAGS_PAR_TX_NONE) != 0U) {
    reg |= ST25R3918_REG_ISO14443A_NFC_no_tx_par;
  }

  /* Apply current TxRx flags on ISO14443A and NFC 106kb/s Settings Register */
  st25r3918ChangeRegisterBits(ST25R3918_REG_ISO14443A_NFC, (ST25R3918_REG_ISO14443A_NFC_no_tx_par | ST25R3918_REG_ISO14443A_NFC_no_rx_par | ST25R3918_REG_ISO14443A_NFC_nfc_f0), reg);

  /* Check if AGC is to be disabled */
  if ((gRFAL.TxRx.ctx.flags & (uint8_t)RFAL_TXRX_FLAGS_AGC_OFF) != 0U) {
    st25r3918ClrRegisterBits(ST25R3918_REG_RX_CONF2, ST25R3918_REG_RX_CONF2_agc_en);
  } else {
    st25r3918SetRegisterBits(ST25R3918_REG_RX_CONF2, ST25R3918_REG_RX_CONF2_agc_en);
  }
  /*******************************************************************************/
  ...
  if (gRFAL.conf.eHandling == RFAL_ERRORHANDLING_EMVCO) {
    st25r3918SetRegisterBits(ST25R3918_REG_TIMER_EMV_CONTROL, ST25R3918_REG_TIMER_EMV_CONTROL_nrt_emv);
    maskInterrupts |= ST25R3918_IRQ_MASK_RX_REST;
  } else {
    st25r3918ClrRegisterBits(ST25R3918_REG_TIMER_EMV_CONTROL, ST25R3918_REG_TIMER_EMV_CONTROL_nrt_emv);
  }
  /*******************************************************************************/

  /* In Passive Listen mode additionally enable External Field interrupts  */
  if (rfalIsModePassiveListen(gRFAL.mode)) {
    maskInterrupts |= (ST25R3918_IRQ_MASK_EOF | ST25R3918_IRQ_MASK_WU_F);        /* Enable external Field interrupts to detect Link Loss and SENF_REQ auto responses */
  }

  /* In Active comms enable also External Field interrupts  */
  if (rfalIsModeActiveComm(gRFAL.mode)) {
    maskInterrupts |= (ST25R3918_IRQ_MASK_EOF  | ST25R3918_IRQ_MASK_EON  | ST25R3918_IRQ_MASK_PPON2 | ST25R3918_IRQ_MASK_CAT | ST25R3918_IRQ_MASK_CAC);
  }

  /*******************************************************************************/
  /* clear and enable these interrupts */
  st25r3918GetInterrupt(maskInterrupts);
  st25r3918EnableInterrupts(maskInterrupts);
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalTransceiveTx(void)
{
  ...
  switch (gRFAL.TxRx.state) {
    ...
    case RFAL_TXRX_STATE_TX_TRANSMIT:   /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      if ((RFAL_MODE_POLL_NFCV == gRFAL.mode) || (RFAL_MODE_POLL_PICOPASS == gRFAL.mode)) {
        ...
        st25r3918WriteFifo(gRFAL.TxRx.ctx.txBuf, rfalConvBitsToBytes(gRFAL.TxRx.ctx.txBufLen));
        st25r3918ExecuteCommand(ST25R3918_CMD_CLEAR_FIFO);
#endif
        ...
        ret = iso15693VCDCode(gRFAL.TxRx.ctx.txBuf, rfalConvBitsToBytes(gRFAL.TxRx.ctx.txBufLen), (((gRFAL.nfcvData.origCtx.flags & (uint32_t)RFAL_TXRX_FLAGS_CRC_TX_MANUAL) != 0U) ? false : true), (((gRFAL.nfcvData.origCtx.flags & (uint32_t)RFAL_TXRX_FLAGS_NFCV_FLAG_MANUAL) != 0U) ? false : true), (RFAL_MODE_POLL_PICOPASS == gRFAL.mode),
                              &gRFAL.fifo.bytesTotal, &gRFAL.nfcvData.nfcvOffset, gRFAL.nfcvData.codingBuffer, MIN((uint16_t)ST25R3918_FIFO_DEPTH, (uint16_t)sizeof(gRFAL.nfcvData.codingBuffer)), &gRFAL.fifo.bytesWritten);
        ...
        st25r3918SetNumTxBits((uint16_t)rfalConvBytesToBits(gRFAL.fifo.bytesTotal));

        /* Load FIFO with coded bytes */
        st25r3918WriteFifo(gRFAL.nfcvData.codingBuffer, gRFAL.fifo.bytesWritten);
      ...
      /*******************************************************************************/
        ...
        /* Set the number of full bytes and bits to be transmitted */
        st25r3918SetNumTxBits(gRFAL.TxRx.ctx.txBufLen);

        /* Load FIFO with total length or FIFO's maximum */
        gRFAL.fifo.bytesWritten = MIN(gRFAL.fifo.bytesTotal, ST25R3918_FIFO_DEPTH);
        st25r3918WriteFifo(gRFAL.TxRx.ctx.txBuf, gRFAL.fifo.bytesWritten);
      }
      ...
      if ((gRFAL.TxRx.ctx.flags & (uint32_t)RFAL_TXRX_FLAGS_CRC_TX_MANUAL) != 0U) {
        st25r3918ExecuteCommand(ST25R3918_CMD_TRANSMIT_WITHOUT_CRC);
      } else {
        st25r3918ExecuteCommand(ST25R3918_CMD_TRANSMIT_WITH_CRC);
      }
    ...
    case RFAL_TXRX_STATE_TX_WAIT_WL:
      ...
      irqs = st25r3918GetInterrupt((ST25R3918_IRQ_MASK_FWL | ST25R3918_IRQ_MASK_TXE));
      if (irqs == ST25R3918_IRQ_MASK_NONE) {
        break;  /* No interrupt to process */
      }

      if (((irqs & ST25R3918_IRQ_MASK_FWL) != 0U) && ((irqs & ST25R3918_IRQ_MASK_TXE) == 0U)) {
    ...
    case RFAL_TXRX_STATE_TX_RELOAD_FIFO:   /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      if ((RFAL_MODE_POLL_NFCV == gRFAL.mode) || (RFAL_MODE_POLL_PICOPASS == gRFAL.mode)) {
        ...
        /* Load FIFO with coded bytes */
        st25r3918WriteFifo(gRFAL.nfcvData.codingBuffer, tmp);
      }
      /*******************************************************************************/
      else {
        ...
        st25r3918WriteFifo(&gRFAL.TxRx.ctx.txBuf[gRFAL.fifo.bytesWritten], tmp);
      }
    ...
    case RFAL_TXRX_STATE_TX_WAIT_TXE:
      ...
      if ((irqs & ST25R3918_IRQ_MASK_TXE) != 0U) {
        gRFAL.TxRx.state = RFAL_TXRX_STATE_TX_DONE;
      } else if ((irqs & ST25R3918_IRQ_MASK_FWL) != 0U) {
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalTransceiveRx(void)
{
  volatile uint32_t irqs;
  uint16_t          tmp;
  uint16_t          aux;
  ...
  switch (gRFAL.TxRx.state) {
    ...
    case RFAL_TXRX_STATE_RX_WAIT_RXS:
      ...
      /*******************************************************************************/
      irqs = st25r3918GetInterrupt((ST25R3918_IRQ_MASK_RXS | ST25R3918_IRQ_MASK_NRE | ST25R3918_IRQ_MASK_EOF));
      if (irqs == ST25R3918_IRQ_MASK_NONE) {
        break;  /* No interrupt to process */
      }

      /* Only raise Timeout if NRE is detected with no Rx Start (NRT EMV mode) */
      if (((irqs & ST25R3918_IRQ_MASK_NRE) != 0U) && ((irqs & ST25R3918_IRQ_MASK_RXS) == 0U)) {
      ...
      if (((irqs & ST25R3918_IRQ_MASK_EOF) != 0U) && ((irqs & ST25R3918_IRQ_MASK_RXS) == 0U)) {
      ...
      if ((irqs & ST25R3918_IRQ_MASK_RXS) != 0U) {
        /*******************************************************************************/
        /* REMARK: Silicon workaround ST25R3918 Errata #TBD                            */
      ...
      irqs &= ~(ST25R3918_IRQ_MASK_RXS | ST25R3918_IRQ_MASK_NRE);
    ...
    case RFAL_TXRX_STATE_RX_WAIT_RXE:   /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      irqs |= st25r3918GetInterrupt((ST25R3918_IRQ_MASK_RXE  | ST25R3918_IRQ_MASK_FWL | ST25R3918_IRQ_MASK_EOF | ST25R3918_IRQ_MASK_RX_REST | ST25R3918_IRQ_MASK_WU_F));
      if (irqs == ST25R3918_IRQ_MASK_NONE) {
        break;  /* No interrupt to process */
      }

      if ((irqs & ST25R3918_IRQ_MASK_RX_REST) != 0U) {
        ...
        if (st25r3918GetInterrupt(ST25R3918_IRQ_MASK_NRE) != 0U) {
          gRFAL.TxRx.status = ERR_TIMEOUT;
          gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_FAIL;
          break;
        }
        if (st25r3918CheckReg(ST25R3918_REG_NFCIP1_BIT_RATE, ST25R3918_REG_NFCIP1_BIT_RATE_nrt_on, 0)) {    /* MISRA 13.5 */
          gRFAL.TxRx.status = ERR_TIMEOUT;
          gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_FAIL;
          break;
        }
        ...
        st25r3918GetInterrupt(ST25R3918_IRQ_MASK_RXS);

        /* Check whether a following reception has already started */
        if (st25r3918CheckReg(ST25R3918_REG_AUX_DISPLAY, ST25R3918_REG_AUX_DISPLAY_rx_act, ST25R3918_REG_AUX_DISPLAY_rx_act)) {
          gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_WAIT_RXE;
          break;
        }
      ...
      if (((irqs & ST25R3918_IRQ_MASK_FWL) != 0U) && ((irqs & ST25R3918_IRQ_MASK_RXE) == 0U)) {
        gRFAL.TxRx.state = RFAL_TXRX_STATE_RX_READ_FIFO;
        break;
      }

      /* Automatic responses allowed during TxRx only for the SENSF_REQ */
      if ((irqs & ST25R3918_IRQ_MASK_WU_F) != 0U) {
        gRFAL.TxRx.state = RFAL_TXRX_STATE_RX_WAIT_RXS;
        break;
      }

      /* After RXE retrieve and check for any error irqs */
      irqs |= st25r3918GetInterrupt((ST25R3918_IRQ_MASK_CRC | ST25R3918_IRQ_MASK_PAR | ST25R3918_IRQ_MASK_ERR1 | ST25R3918_IRQ_MASK_ERR2 | ST25R3918_IRQ_MASK_COL));
    ...
    case RFAL_TXRX_STATE_RX_ERR_CHECK:   /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      if ((irqs & ST25R3918_IRQ_MASK_ERR1) != 0U) {
        gRFAL.TxRx.status = ERR_FRAMING;
      ...
      /* Discard Soft Framing errors in AP2P and CE */
      else if (rfalIsModePassivePoll(gRFAL.mode) && ((irqs & ST25R3918_IRQ_MASK_ERR2) != 0U)) {
        gRFAL.TxRx.status = ERR_FRAMING;
        gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_READ_DATA;
        ...
        rfalErrorHandling();
        break;
      } else if ((irqs & ST25R3918_IRQ_MASK_PAR) != 0U) {
        ...
        rfalErrorHandling();
        break;
      } else if ((irqs & ST25R3918_IRQ_MASK_CRC) != 0U) {
        ...
        rfalErrorHandling();
        break;
      } else if ((irqs & ST25R3918_IRQ_MASK_COL) != 0U) {
        ...
        rfalErrorHandling();
        break;
      } else if (rfalIsModePassiveListen(gRFAL.mode) && ((irqs & ST25R3918_IRQ_MASK_EOF) != 0U)) {
        gRFAL.TxRx.status = ERR_LINK_LOSS;
        gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_FAIL;
        break;
      } else if ((irqs & ST25R3918_IRQ_MASK_RXE) != 0U) {
    ...
    case RFAL_TXRX_STATE_RX_READ_DATA:   /*  PRQA S 2003 # MISRA 16.3 - Intentional fall through */
      ...
      st25r3918ReadFifo(&gRFAL.TxRx.ctx.rxBuf[gRFAL.fifo.bytesWritten], tmp);
      if (gRFAL.TxRx.ctx.rxRcvdLen != NULL) {
...
#if 0
        /* Debugging code: output the payload bits by writing into the FIFO and subsequent clearing */
        st25r3918WriteFifo(gRFAL.nfcvData.origCtx.rxBuf, rfalConvBitsToBytes(*gRFAL.nfcvData.origCtx.rxRcvdLen));
        st25r3918ExecuteCommand(ST25R3918_CMD_CLEAR_FIFO);
#endif
    ...
    case RFAL_TXRX_STATE_RX_READ_FIFO:
      ...
      st25r3918ReadFifo(&gRFAL.TxRx.ctx.rxBuf[gRFAL.fifo.bytesWritten], aux);
      ...
      if (aux < tmp) {
        st25r3918ReadFifo(NULL, (tmp - aux));
      }
    ...
    case RFAL_TXRX_STATE_RX_WAIT_EON:
      ...
      irqs = st25r3918GetInterrupt((ST25R3918_IRQ_MASK_EON | ST25R3918_IRQ_MASK_NRE | ST25R3918_IRQ_MASK_PPON2));
      if (irqs == ST25R3918_IRQ_MASK_NONE) {
        break;  /* No interrupt to process */
      }

      if ((irqs & ST25R3918_IRQ_MASK_EON) != 0U) {
        gRFAL.TxRx.state = RFAL_TXRX_STATE_RX_WAIT_RXS;
      }

      if ((irqs & ST25R3918_IRQ_MASK_NRE) != 0U) {
        gRFAL.TxRx.status = ERR_TIMEOUT;
        gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_FAIL;
      }
      if ((irqs & ST25R3918_IRQ_MASK_PPON2) != 0U) {
        gRFAL.TxRx.status = ERR_LINK_LOSS;
        gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_FAIL;
      }
      break;
    ...
    case RFAL_TXRX_STATE_RX_WAIT_EOF:
      ...
      irqs = st25r3918GetInterrupt((ST25R3918_IRQ_MASK_CAT | ST25R3918_IRQ_MASK_CAC));
      if (irqs == ST25R3918_IRQ_MASK_NONE) {
        break;  /* No interrupt to process */
      }

      if ((irqs & ST25R3918_IRQ_MASK_CAT) != 0U) {
        gRFAL.TxRx.state = RFAL_TXRX_STATE_RX_DONE;
      } else if ((irqs & ST25R3918_IRQ_MASK_CAC) != 0U) {
        gRFAL.TxRx.status = ERR_RF_COLLISION;
        gRFAL.TxRx.state  = RFAL_TXRX_STATE_RX_FAIL;
      } else {
        gRFAL.TxRx.status = ERR_IO;
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalFIFOStatusUpdate(void)
{
  if (gRFAL.fifo.status[RFAL_FIFO_STATUS_REG2] == RFAL_FIFO_STATUS_INVALID) {
    st25r3918ReadMultipleRegisters(ST25R3918_REG_FIFO_STATUS1, gRFAL.fifo.status, ST25R3918_FIFO_STATUS_LEN);
  }
}


/*******************************************************************************/
void RfalRfST25R3918Class::rfalFIFOStatusClear(void)
{
...
/*******************************************************************************/
uint8_t RfalRfST25R3918Class::rfalFIFOStatusGetNumBytes(void)
{
  uint16_t result;

  rfalFIFOStatusUpdate();

  result  = ((((uint16_t)gRFAL.fifo.status[RFAL_FIFO_STATUS_REG2] & ST25R3918_REG_FIFO_STATUS2_fifo_b_mask) >> ST25R3918_REG_FIFO_STATUS2_fifo_b_shift) << RFAL_BITS_IN_BYTE);
...
/*******************************************************************************/
bool RfalRfST25R3918Class::rfalFIFOStatusIsIncompleteByte(void)
{
  rfalFIFOStatusUpdate();
  return ((gRFAL.fifo.status[RFAL_FIFO_STATUS_REG2] & ST25R3918_REG_FIFO_STATUS2_fifo_lb_mask) != 0U);
}


/*******************************************************************************/
bool RfalRfST25R3918Class::rfalFIFOStatusIsMissingPar(void)
{
  rfalFIFOStatusUpdate();
  return ((gRFAL.fifo.status[RFAL_FIFO_STATUS_REG2] & ST25R3918_REG_FIFO_STATUS2_np_lb) != 0U);
}


/*******************************************************************************/
uint8_t RfalRfST25R3918Class::rfalFIFOGetNumIncompleteBits(void)
{
  rfalFIFOStatusUpdate();
  return ((gRFAL.fifo.status[RFAL_FIFO_STATUS_REG2] & ST25R3918_REG_FIFO_STATUS2_fifo_lb_mask) >> ST25R3918_REG_FIFO_STATUS2_fifo_lb_shift);
}

/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalISO14443ATransceiveShortFrame(rfal14443AShortFrameCmd txCmd, uint8_t *rxBuf, uint8_t rxBufLen, uint16_t *rxRcvdLen, uint32_t fwt)
{
  ReturnCode ret;
  uint8_t    directCmd;

  /* Check if RFAL is properly initialized */
  if (!st25r3918IsTxEnabled() || (gRFAL.state < RFAL_STATE_MODE_SET) || ((gRFAL.mode != RFAL_MODE_POLL_NFCA) && (gRFAL.mode != RFAL_MODE_POLL_NFCA_T1T))) {
    return ERR_WRONG_STATE;
  }
  ...
  switch (txCmd) {
    case RFAL_14443A_SHORTFRAME_CMD_WUPA:
      directCmd = ST25R3918_CMD_TRANSMIT_WUPA;
      break;

    case RFAL_14443A_SHORTFRAME_CMD_REQA:
      directCmd = ST25R3918_CMD_TRANSMIT_REQA;
      break;
  ...
  st25r3918SetRegisterBits(ST25R3918_REG_AUX, ST25R3918_REG_AUX_no_crc_rx);


  /*******************************************************************************/
  /* Wait for GT and FDT */
  while (!rfalIsGTExpired())      { /* MISRA 15.6: mandatory brackets */ };
  while (st25r3918IsGPTRunning()) { /* MISRA 15.6: mandatory brackets */ };
  ...
  /*******************************************************************************/
  /* Load NRT with FWT */
  st25r3918SetNoResponseTime(rfalConv1fcTo64fc(MIN((fwt + RFAL_FWT_ADJUSTMENT + RFAL_FWT_A_ADJUSTMENT), RFAL_ST25R3918_NRT_MAX_1FC)));
  ...
  if (gRFAL.timings.FDTListen != RFAL_TIMING_NONE) {
    ...
    /* Set Minimum FDT(Listen) in which PICC is not allowed to send a response */
    st25r3918WriteRegister(ST25R3918_REG_MASK_RX_TIMER, (uint8_t)rfalConv1fcTo64fc(((RFAL_FDT_LISTEN_MRT_ADJUSTMENT + RFAL_FDT_LISTEN_A_ADJUSTMENT) > gRFAL.timings.FDTListen) ? RFAL_ST25R3918_MRT_MIN_1FC : (gRFAL.timings.FDTListen - (RFAL_FDT_LISTEN_MRT_ADJUSTMENT + RFAL_FDT_LISTEN_A_ADJUSTMENT))));
  }
  ...
  st25r3918GetInterrupt(ST25R3918_IRQ_MASK_COL);
  st25r3918EnableInterrupts(ST25R3918_IRQ_MASK_COL);
  ...
  st25r3918WriteRegister(ST25R3918_REG_NUM_TX_BYTES2, 0);

  /* Send either WUPA or REQA. All affected tags will backscatter ATQA and change to READY state */
  st25r3918ExecuteCommand(directCmd);

  /* Wait for TXE */
  if (st25r3918WaitForInterruptsTimed(ST25R3918_IRQ_MASK_TXE, (uint16_t)MAX(rfalConv1fcToMs(fwt), RFAL_ST25R3918_SW_TMR_MIN_1MS)) == 0U) {
    ret = ERR_IO;
  } else {
    /*Check if Observation Mode is enabled and set it on ST25R391x */
    rfalCheckEnableObsModeRx();
  ...
  st25r3918DisableInterrupts((ST25R3918_IRQ_MASK_COL));

  /* Re-enable CRC on Rx */
  st25r3918ClrRegisterBits(ST25R3918_REG_AUX, ST25R3918_REG_AUX_no_crc_rx);

  return ret;
}

/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalISO14443ATransceiveAnticollisionFrame(uint8_t *buf, uint8_t *bytesToSend, uint8_t *bitsToSend, uint16_t *rxLength, uint32_t fwt)
{
  ReturnCode            ret;
  rfalTransceiveContext ctx;
  uint8_t               collByte;
  ...
  st25r3918SetRegisterBits(ST25R3918_REG_ISO14443A_NFC, ST25R3918_REG_ISO14443A_NFC_antcl);
  ...
  ctx.flags    |= (st25r3918CheckReg(ST25R3918_REG_AUX, ST25R3918_REG_AUX_dis_corr, ST25R3918_REG_AUX_dis_corr) ? (uint32_t)RFAL_TXRX_FLAGS_AGC_OFF : 0x00U);
  ...
  if (ret == ERR_NONE) {
    ...
    if ((ERR_RF_COLLISION == ret)) {
      ...
      st25r3918ReadRegister(ST25R3918_REG_COLLISION_STATUS, &collData);

      (*bytesToSend) = ((collData >> ST25R3918_REG_COLLISION_STATUS_c_byte_shift) & 0x0FU); // 4-bits Byte information
      (*bitsToSend)  = ((collData >> ST25R3918_REG_COLLISION_STATUS_c_bit_shift)  & 0x07U); // 3-bits bit information
  ...
  st25r3918ClrRegisterBits(ST25R3918_REG_ISO14443A_NFC, ST25R3918_REG_ISO14443A_NFC_antcl);
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalISO15693TransceiveAnticollisionFrame(uint8_t *txBuf, uint8_t txBufLen, uint8_t *rxBuf, uint8_t rxBufLen, uint16_t *actLen)
{
  ReturnCode            ret;
  rfalTransceiveContext ctx;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalISO15693TransceiveEOFAnticollision(uint8_t *rxBuf, uint8_t rxBufLen, uint16_t *actLen)
{
  uint8_t dummy;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalISO15693TransceiveEOF(uint8_t *rxBuf, uint8_t rxBufLen, uint16_t *actLen)
{
  ReturnCode ret;
  uint8_t    dummy;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalFeliCaPoll(rfalFeliCaPollSlots slots, uint16_t sysCode, uint8_t reqCode, rfalFeliCaPollRes *pollResList, uint8_t pollResListSize, uint8_t *devicesDetected, uint8_t *collisionsDetected)
{
  ReturnCode        ret;
  ...
  if (ret == ERR_NONE) {
    ...
    do {
      ...
      if (ret == ERR_TIMEOUT) {
        ...
        timeout = st25r3918CheckReg(ST25R3918_REG_NFCIP1_BIT_RATE, ST25R3918_REG_NFCIP1_BIT_RATE_nrt_on, 0x00);
        if (!timeout) {
...
/*******************************************************************************/
bool RfalRfST25R3918Class::rfalIsExtFieldOn(void)
{
  return st25r3918IsExtFieldOn();
}

/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalListenStart(uint32_t lmMask, const rfalLmConfPA *confA, const rfalLmConfPB *confB, const rfalLmConfPF *confF, uint8_t *rxBuf, uint16_t rxBufLen, uint16_t *rxLen)
{
  (void)lmMask;
  (void)confA;
  (void)confB;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalListenSleepStart(rfalLmState sleepSt, uint8_t *rxBuf, uint16_t rxBufLen, uint16_t *rxLen)
{
  (void)sleepSt;
  (void)rxBuf;
  (void)rxBufLen;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalListenStop(void)
{
  return ERR_NOTSUPP;
}

/*******************************************************************************/
rfalLmState RfalRfST25R3918Class::rfalListenGetState(bool *dataFlag, rfalBitRate *lastBR)
{
  (void)dataFlag;
  (void)lastBR;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalListenSetState(rfalLmState newSt)
{
  (void)newSt;
  return ERR_NOTSUPP;
}
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalWakeUpModeStart(const rfalWakeUpConfig *config)
{
  uint8_t                aux;
  uint8_t                reg;
  uint32_t               irqs;
  ...
  st25r3918TxRxOff();
  st25r3918ClrRegisterBits(ST25R3918_REG_OP_CONTROL, ST25R3918_REG_OP_CONTROL_en_fd_mask);
  st25r3918ChangeRegisterBits(ST25R3918_REG_MODE, (ST25R3918_REG_MODE_targ | ST25R3918_REG_MODE_om_mask), (ST25R3918_REG_MODE_targ_init | ST25R3918_REG_MODE_om_iso14443a));
  ...
  if (st25r3918CheckReg(ST25R3918_REG_IO_CONF2, ST25R3918_REG_IO_CONF2_aat_en, ST25R3918_REG_IO_CONF2_aat_en) && !gRFAL.wum.cfg.swTagDetect) {
    st25r3918ClrRegisterBits(ST25R3918_REG_OP_CONTROL, ST25R3918_REG_OP_CONTROL_en);
    delay(RFAL_ST25R3918_AAT_SETTLE_OFF);
  }
  /* In SW Tag detection remain in ready let the varicaps settle  */
  else if (gRFAL.wum.cfg.swTagDetect) {
    delay(RFAL_ST25R3918_AAT_SETTLE_ON);
  } else {
    /* MISRA 15.7 - Empty else */
  }
  ...
  reg  = (uint8_t)(((uint8_t)gRFAL.wum.cfg.period & 0x0FU) << ST25R3918_REG_WUP_TIMER_CONTROL_wut_shift);
  reg |= (uint8_t)(((uint8_t)gRFAL.wum.cfg.period < (uint8_t)RFAL_WUM_PERIOD_100MS) ? ST25R3918_REG_WUP_TIMER_CONTROL_wur : 0x00U);

  if (gRFAL.wum.cfg.irqTout || gRFAL.wum.cfg.swTagDetect) {
    reg  |= ST25R3918_REG_WUP_TIMER_CONTROL_wto;
    irqs |= ST25R3918_IRQ_MASK_WT;
  }

  /*******************************************************************************/
  /* Check if Inductive Amplitude is to be performed */
  if (gRFAL.wum.cfg.indAmp.enabled) {
    aux  = (uint8_t)((gRFAL.wum.cfg.indAmp.delta) << ST25R3918_REG_AMPLITUDE_MEASURE_CONF_am_d_shift);
    aux |= (uint8_t)(gRFAL.wum.cfg.indAmp.aaInclMeas ? ST25R3918_REG_AMPLITUDE_MEASURE_CONF_am_aam : 0x00U);
    aux |= (uint8_t)(((uint8_t)gRFAL.wum.cfg.indAmp.aaWeight << ST25R3918_REG_AMPLITUDE_MEASURE_CONF_am_aew_shift) & ST25R3918_REG_AMPLITUDE_MEASURE_CONF_am_aew_mask);
    aux |= (uint8_t)(gRFAL.wum.cfg.indAmp.autoAvg ? ST25R3918_REG_AMPLITUDE_MEASURE_CONF_am_ae : 0x00U);

    st25r3918WriteRegister(ST25R3918_REG_AMPLITUDE_MEASURE_CONF, aux);
    ...
    if (!gRFAL.wum.cfg.indAmp.autoAvg || gRFAL.wum.cfg.swTagDetect) {
      if (gRFAL.wum.cfg.indAmp.reference == RFAL_WUM_REFERENCE_AUTO) {
        st25r3918MeasureAmplitude(&gRFAL.wum.cfg.indAmp.reference);
      }
      st25r3918WriteRegister(ST25R3918_REG_AMPLITUDE_MEASURE_REF, gRFAL.wum.cfg.indAmp.reference);
    }

    reg  |= ST25R3918_REG_WUP_TIMER_CONTROL_wam;
    irqs |= ST25R3918_IRQ_MASK_WAM;
  }

  /*******************************************************************************/
  /* Check if Inductive Phase is to be performed */
  if (gRFAL.wum.cfg.indPha.enabled) {
    aux  = (uint8_t)((gRFAL.wum.cfg.indPha.delta) << ST25R3918_REG_PHASE_MEASURE_CONF_pm_d_shift);
    aux |= (uint8_t)(gRFAL.wum.cfg.indPha.aaInclMeas ? ST25R3918_REG_PHASE_MEASURE_CONF_pm_aam : 0x00U);
    aux |= (uint8_t)(((uint8_t)gRFAL.wum.cfg.indPha.aaWeight << ST25R3918_REG_PHASE_MEASURE_CONF_pm_aew_shift) & ST25R3918_REG_PHASE_MEASURE_CONF_pm_aew_mask);
    aux |= (uint8_t)(gRFAL.wum.cfg.indPha.autoAvg ? ST25R3918_REG_PHASE_MEASURE_CONF_pm_ae : 0x00U);

    st25r3918WriteRegister(ST25R3918_REG_PHASE_MEASURE_CONF, aux);

    /* Only need to set the reference if not using Auto Average */
    if (!gRFAL.wum.cfg.indPha.autoAvg || gRFAL.wum.cfg.swTagDetect) {
      if (gRFAL.wum.cfg.indPha.reference == RFAL_WUM_REFERENCE_AUTO) {
        st25r3918MeasurePhase(&gRFAL.wum.cfg.indPha.reference);

      }
      st25r3918WriteRegister(ST25R3918_REG_PHASE_MEASURE_REF, gRFAL.wum.cfg.indPha.reference);
    }

    reg  |= ST25R3918_REG_WUP_TIMER_CONTROL_wph;
    irqs |= ST25R3918_IRQ_MASK_WPH;
  }
  ...
  if (gRFAL.wum.cfg.cap.enabled) {
    ...
    st25r3918ClrRegisterBits(ST25R3918_REG_OP_CONTROL, (ST25R3918_REG_OP_CONTROL_en | ST25R3918_REG_OP_CONTROL_tx_en));

    /* Sensor gain should be configured on Analog Config: RFAL_ANALOG_CONFIG_CHIP_WAKEUP_ON */

    /* Perform calibration procedure */
    st25r3918CalibrateCapacitiveSensor(NULL);


    /*******************************************************************************/
    aux  = (uint8_t)((gRFAL.wum.cfg.cap.delta) << ST25R3918_REG_CAPACITANCE_MEASURE_CONF_cm_d_shift);
    aux |= (uint8_t)(gRFAL.wum.cfg.cap.aaInclMeas ? ST25R3918_REG_CAPACITANCE_MEASURE_CONF_cm_aam : 0x00U);
    aux |= (uint8_t)(((uint8_t)gRFAL.wum.cfg.cap.aaWeight << ST25R3918_REG_CAPACITANCE_MEASURE_CONF_cm_aew_shift) & ST25R3918_REG_CAPACITANCE_MEASURE_CONF_cm_aew_mask);
    aux |= (uint8_t)(gRFAL.wum.cfg.cap.autoAvg ? ST25R3918_REG_CAPACITANCE_MEASURE_CONF_cm_ae : 0x00U);

    st25r3918WriteRegister(ST25R3918_REG_CAPACITANCE_MEASURE_CONF, aux);

    /* Only need to set the reference if not using Auto Average */
    if (!gRFAL.wum.cfg.cap.autoAvg || gRFAL.wum.cfg.swTagDetect) {
      if (gRFAL.wum.cfg.indPha.reference == RFAL_WUM_REFERENCE_AUTO) {
        st25r3918MeasureCapacitance(&gRFAL.wum.cfg.cap.reference);
      }
      st25r3918WriteRegister(ST25R3918_REG_CAPACITANCE_MEASURE_REF, gRFAL.wum.cfg.cap.reference);
    }

    reg  |= ST25R3918_REG_WUP_TIMER_CONTROL_wcap;
    irqs |= ST25R3918_IRQ_MASK_WCAP;
  }


  /* Disable and clear all interrupts except Wake-Up IRQs */
  st25r3918DisableInterrupts(ST25R3918_IRQ_MASK_ALL);
  st25r3918GetInterrupt(irqs);
  st25r3918EnableInterrupts(irqs);

  /* On SW Tag Detection no HW automatic measurements are to be performed, only make use of WTO */
  if (gRFAL.wum.cfg.swTagDetect) {
    reg &= ~(ST25R3918_REG_WUP_TIMER_CONTROL_wam | ST25R3918_REG_WUP_TIMER_CONTROL_wph | ST25R3918_REG_WUP_TIMER_CONTROL_wcap);
  }

  /* Enable Low Power Wake-Up Mode (Disable: Oscilattor, Tx, Rx and External Field Detector)*/
  st25r3918WriteRegister(ST25R3918_REG_WUP_TIMER_CONTROL, reg);
  st25r3918ChangeRegisterBits(ST25R3918_REG_OP_CONTROL,
                              (ST25R3918_REG_OP_CONTROL_en | ST25R3918_REG_OP_CONTROL_rx_en | ST25R3918_REG_OP_CONTROL_tx_en |
                               ST25R3918_REG_OP_CONTROL_en_fd_mask | ST25R3918_REG_OP_CONTROL_wu),
                              ST25R3918_REG_OP_CONTROL_wu);
...
/*******************************************************************************/
bool RfalRfST25R3918Class::rfalWakeUpModeHasWoke(void)
{
...
/*******************************************************************************/
void RfalRfST25R3918Class::rfalRunWakeUpModeWorker(void)
{
  uint32_t irqs;
  uint8_t  reg;
  ...
  switch (gRFAL.wum.state) {
    ...
    case RFAL_WUM_STATE_ENABLED_WOKE:
      ...
      irqs = st25r3918GetInterrupt((ST25R3918_IRQ_MASK_WT | ST25R3918_IRQ_MASK_WAM | ST25R3918_IRQ_MASK_WPH | ST25R3918_IRQ_MASK_WCAP));
      if (irqs == ST25R3918_IRQ_MASK_NONE) {
        break;  /* No interrupt to process */
      }
      ...
      if ((irqs & ST25R3918_IRQ_MASK_WAM) != 0U) {
        st25r3918ReadRegister(ST25R3918_REG_AMPLITUDE_MEASURE_RESULT, &reg);
        gRFAL.wum.state = RFAL_WUM_STATE_ENABLED_WOKE;
      }

      if ((irqs & ST25R3918_IRQ_MASK_WPH) != 0U) {
        st25r3918ReadRegister(ST25R3918_REG_PHASE_MEASURE_RESULT, &reg);
        gRFAL.wum.state = RFAL_WUM_STATE_ENABLED_WOKE;
      }

      if ((irqs & ST25R3918_IRQ_MASK_WCAP) != 0U) {
        st25r3918ReadRegister(ST25R3918_REG_CAPACITANCE_MEASURE_RESULT, &reg);
        gRFAL.wum.state = RFAL_WUM_STATE_ENABLED_WOKE;
      }

      if ((irqs & ST25R3918_IRQ_MASK_WT) != 0U) {
        /*******************************************************************************/
        if (gRFAL.wum.cfg.swTagDetect) {
          /* Enable Ready mode */
          st25r3918ChangeRegisterBits(ST25R3918_REG_OP_CONTROL, (ST25R3918_REG_OP_CONTROL_en | ST25R3918_REG_OP_CONTROL_wu), (ST25R3918_REG_OP_CONTROL_en));
          delay(RFAL_ST25R3918_AAT_SETTLE_ON);


          if (gRFAL.wum.cfg.indAmp.enabled) {
            st25r3918MeasureAmplitude(&reg);
          ...
          if (gRFAL.wum.cfg.cap.enabled) {
            st25r3918MeasureCapacitance(&reg);
          ...
          st25r3918ChangeRegisterBits(ST25R3918_REG_OP_CONTROL, (ST25R3918_REG_OP_CONTROL_en | ST25R3918_REG_OP_CONTROL_wu), (ST25R3918_REG_OP_CONTROL_wu));
        }
      }
      break;
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalWakeUpModeStop(void)
{
  ...
  st25r3918ClrRegisterBits(ST25R3918_REG_OP_CONTROL, ST25R3918_REG_OP_CONTROL_wu);
  st25r3918DisableInterrupts((ST25R3918_IRQ_MASK_WT | ST25R3918_IRQ_MASK_WAM | ST25R3918_IRQ_MASK_WPH | ST25R3918_IRQ_MASK_WCAP));
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipWriteReg(uint16_t reg, const uint8_t *values, uint8_t len)
{
  if (!st25r3918IsRegValid((uint8_t)reg)) {
    return ERR_PARAM;
  }

  return st25r3918WriteMultipleRegisters((uint8_t)reg, values, len);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipReadReg(uint16_t reg, uint8_t *values, uint8_t len)
{
  if (!st25r3918IsRegValid((uint8_t)reg)) {
    return ERR_PARAM;
  }

  return st25r3918ReadMultipleRegisters((uint8_t)reg, values, len);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipExecCmd(uint16_t cmd)
{
  if (!st25r3918IsCmdValid((uint8_t)cmd)) {
    return ERR_PARAM;
  }

  return st25r3918ExecuteCommand((uint8_t) cmd);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipWriteTestReg(uint16_t reg, uint8_t value)
{
  return st25r3918WriteTestRegister((uint8_t)reg, value);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipReadTestReg(uint16_t reg, uint8_t *value)
{
  return st25r3918ReadTestRegister((uint8_t)reg, value);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipChangeRegBits(uint16_t reg, uint8_t valueMask, uint8_t value)
{
  if (!st25r3918IsRegValid((uint8_t)reg)) {
    return ERR_PARAM;
  }

  return st25r3918ChangeRegisterBits((uint8_t)reg, valueMask, value);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipChangeTestRegBits(uint16_t reg, uint8_t valueMask, uint8_t value)
{
  st25r3918ChangeTestRegisterBits((uint8_t)reg, valueMask, value);
  return ERR_NONE;
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipSetRFO(uint8_t rfo)
{
  return st25r3918ChangeRegisterBits(ST25R3918_REG_TX_DRIVER, ST25R3918_REG_TX_DRIVER_d_res_mask, rfo);
}


/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipGetRFO(uint8_t *result)
{
  ReturnCode ret;

  ret = st25r3918ReadRegister(ST25R3918_REG_TX_DRIVER, result);

  (*result) = ((*result) & ST25R3918_REG_TX_DRIVER_d_res_mask);
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipMeasureAmplitude(uint8_t *result)
{
  ReturnCode err;
  uint8_t reg_opc, reg_mode, reg_conf1, reg_conf2;

  /* Save registers which will be adjusted below */
  st25r3918ReadRegister(ST25R3918_REG_OP_CONTROL, &reg_opc);
  st25r3918ReadRegister(ST25R3918_REG_MODE, &reg_mode);
  st25r3918ReadRegister(ST25R3918_REG_RX_CONF1, &reg_conf1);
  st25r3918ReadRegister(ST25R3918_REG_RX_CONF2, &reg_conf2);
  ...
  st25r3918WriteRegister(ST25R3918_REG_OP_CONTROL, (reg_opc & ~ST25R3918_REG_OP_CONTROL_rx_chn));
  st25r3918WriteRegister(ST25R3918_REG_MODE, ST25R3918_REG_MODE_om_iso14443a
                         | ST25R3918_REG_MODE_targ_init
                         | ST25R3918_REG_MODE_tr_am_ook
                         | ST25R3918_REG_MODE_nfc_ar_off);
  st25r3918WriteRegister(ST25R3918_REG_RX_CONF1, (reg_conf1 & ~ST25R3918_REG_RX_CONF1_ch_sel_AM));
  st25r3918WriteRegister(ST25R3918_REG_RX_CONF2, ((reg_conf2 & ~(ST25R3918_REG_RX_CONF2_demod_mode | ST25R3918_REG_RX_CONF2_amd_sel))
                                                  | ST25R3918_REG_RX_CONF2_amd_sel_peak));

  /* Perform the actual measurement */
  err = st25r3918MeasureAmplitude(result);

  /* Restore values */
  st25r3918WriteRegister(ST25R3918_REG_OP_CONTROL, reg_opc);
  st25r3918WriteRegister(ST25R3918_REG_MODE, reg_mode);
  st25r3918WriteRegister(ST25R3918_REG_RX_CONF1, reg_conf1);
  st25r3918WriteRegister(ST25R3918_REG_RX_CONF2, reg_conf2);
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipMeasurePhase(uint8_t *result)
{
  st25r3918MeasurePhase(result);
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipMeasureCapacitance(uint8_t *result)
{
  st25r3918MeasureCapacitance(result);
...
/*******************************************************************************/
ReturnCode RfalRfST25R3918Class::rfalChipMeasurePowerSupply(uint8_t param, uint8_t *result)
{
  *result = st25r3918MeasurePowerSupply(param);

  return ERR_NONE;
}

void RfalRfST25R3918Class::setISRPending(void)
{
  isr_pending = true;
}

bool RfalRfST25R3918Class::isBusBusy(void)
{
  return bus_busy;
}
...
/*******************************************************************************/
extern uint8_t invalid_size_of_stream_configs[(sizeof(struct st25r3918StreamConfig) == sizeof(struct iso15693StreamConfig)) ? 1 : (-1)];
